...
class Dashboard extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['active_magang_count'] = $this->db->where('status_nama', 'Active')->count_all_results('tb_siswa');
    ...
    private function getTotalIntern() {
        $sqlMagang = "SELECT COUNT(DISTINCT nama_siswa) as total_intern FROM tb_siswa";

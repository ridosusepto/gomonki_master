        ...
        <div class="table-responsive">
            <table id="example1" class="table table-bordered table-striped">
                ...
                foreach ($peserta as $ssw) : ?>
                    <tbody>
                        <tr class="text-center highlight-row" data-href="<?= base_url('peserta/detail/' . $ssw->id_siswa) ?>">
                            <td><?= $no++ ?></td>
                            <td><?= $ssw->nis ?></td>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg"> <!-- Tambahkan kelas modal-lg di sini -->
                    <div class="modal-content" style="box-shadow: 0 0 20px rgba(0, 0, 0, 0.2); border: none; border-radius: 10px;">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('peserta/edit_aksi/' . $ssw->id_siswa) ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        <!-- First Column -->
                                        ...
                                        <div class="form-group">
                                            <label>Telepon</label>
                                            <input type="text" name="no_hp" class="form-control" value="<?= $ssw->no_hp ?>">
                                        ...
                                        <div class="form-group">
                                            <label>TTL</label>
                                            <input type="text" name="tanggal_lahir" class="form-control" value="<?= $ssw->tanggal_lahir ?>">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_kelamin" class="form-control">
                                                <option value="<?= $ssw->jenis_kelamin ?>" selected><?= $ssw->jenis_kelamin ?></option>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="inputNIP" class="form-control" value="<?= $ssw->nis ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputNIP">Nama</label>
                                        <input type="text" id="inputNIP" class="form-control" value="<?= $ssw->nama_siswa ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputNIP">Email</label>
                                        <input type="text" id="inputNIP" class="form-control" value="<?= $ssw->email ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputNIP">TTL</label>
                                        <input type="text" id="inputNIP" class="form-control" value="<?= $ssw->tanggal_lahir ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputNIP">Telpon</label>
                                        <input type="text" id="inputNIP" class="form-control" value="<?= $ssw->no_hp ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="inputNama" class="form-control" value="<?= $ssw->jenis_kelamin ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputNama">Alamat</label>
                                        <input type="text" id="inputNama" class="form-control" value="<?= $ssw->alamat ?>" readonly>
                                    </div>
                                    <div class="form-group">

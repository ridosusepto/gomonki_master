                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="id_siswa" id="id_siswa" value="<?= isset($invoice->id_siswa) ? $invoice->id_siswa : '' ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nis">Nis</label>
                                <input type="text" class="form-control" name="nis" id="nis" value="<?= isset($invoice->nis) ? $invoice->nis : '' ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nama_siswa">Nama</label>
                                <input type="text" class="form-control" name="nama_siswa" id="nama_siswa" value="<?= isset($invoice->nama_siswa) ? $invoice->nama_siswa : '' ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <input type="text" class="form-control" name="alamat" id="alamat" value="<?= isset($invoice->alamat) ? $invoice->alamat : '' ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="no_hp">Telepon</label>
                                <input type="text" class="form-control" name="no_hp" id="no_hp" value="<?= isset($invoice->no_hp) ? $invoice->no_hp : '' ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="text" class="form-control" name="email" id="email" value="<?= isset($invoice->email) ? $invoice->email : '' ?>" readonly>
                            </div>
                        </div>
                        <!-- /.card-body -->
                        <!-- </form> -->

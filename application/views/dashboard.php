    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <script>
                ...
                var jumlahPria = dataPeserta.filter(peserta => peserta.jenis_kelamian === 'Laki-Laki').length;
                var jumlahPerempuan = dataPeserta.filter(peserta => peserta.jenis_kelamian === 'Perempuan').length;
